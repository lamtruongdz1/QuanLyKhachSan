...
function validId(val) {
    if (val ==1){
        ...
        document.getElementById('id_card_no').setAttribute('placeholder',"192014132111");
        document.getElementById('id_card_no').setAttribute('data-error',"Thẻ CMND có chứa 12 kí tự số");
    }else if(val ==2){
        ...
        document.getElementById('id_card_no').setAttribute('placeholder',"B4123***");
        document.getElementById('id_card_no').setAttribute('data-error',"Nhập đúng 8 kí tự trong đó kí tự đầu là chữ IN HOA");
    }else if(val == 3){
        document.getElementById('id_card_no').setAttribute('type','number');
        document.getElementById('id_card_no').setAttribute('data-minlength','12');
        document.getElementById('id_card_no').setAttribute('placeholder',"20210040869");
        document.getElementById('id_card_no').setAttribute('data-error',"Nhập đúng 12 kí tự số");
    }
}
